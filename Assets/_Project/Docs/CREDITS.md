...
| ↳ **파생 커서** `Sprites/UI/Generated/Cursor01_2x.png` (위 팩의 2차 저작물) | — | 원본과 동일 (수정 ⭕ / 재배포 ❌) | 위 팩 `Cursor01`(16×16)을 **최근접 2배 확대**한 32×32 인게임 커서. 원본은 1920×1080에서 너무 작고, 픽셀 아트라 보간 확대하면 뭉개진다. 핫스팟은 원본 팁 실측 (5,4)×2 = (10,8). 생성은 `Editor/HudSetupTools.EnsureGameCursor()` — 결정론 재생성 가능 | D7 |
