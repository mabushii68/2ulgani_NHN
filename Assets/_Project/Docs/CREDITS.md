...
| `Sprites/Placeholder_Square.png` (32px), `Placeholder_Circle.png` (64px) | 스프라이트 (플레이스홀더) | 팀 저작 — 프로젝트 자체 코드로 절차적 생성 | D1 회색 박스용 흰색 도형. 외부 에셋·AI 이미지 생성 모델 미사용(단순 for 루프 도형 렌더링)이므로 §5 AI 생성 에셋에 해당하지 않음. 최종 아트로 교체 예정 |
| <!-- 추가 시 행 추가 --> | | | |
