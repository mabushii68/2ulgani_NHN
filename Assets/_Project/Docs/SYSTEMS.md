...
> 해소된 항목은 지우지 않고 ✅ + 처리 위치를 남긴다 (D7 세션 8 현행화).
...
11. ✅ 결과 화면 가운뎃점(`·`)이 □로 렌더링 — 한글 폰트에 U+00B7 없음. `|`로 교체, D7 세션 8 (§16.8)
...
### 16.8 폰트 글리프 결손 전수 검사 (D7 세션 8 — §15.6-11 해소)
...
### 16.9 맵 품질 + 플레이어 UI 4종 (D7 세션 9 — 사람 요구 목록)
